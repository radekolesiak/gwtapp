...
<jsp:useBean id="tag" class="org.gwtapp.template.server.CleanUpBean"/> 
<jsp:useBean id="style" class="org.gwtapp.template.server.CleanUpBean"/> 
<jsp:useBean id="styleclass" class="org.gwtapp.template.server.CleanUpBean"/> 
<jsp:useBean id="body" class="org.gwtapp.template.server.CleanUpBean"/> 
