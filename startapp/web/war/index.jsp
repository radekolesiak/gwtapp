			...
			<div class="row">
				<div class="cell">
    				<div style="width:850px;margin-left:auto;margin-right:auto;">
	    				...
	    				<ul>
							<li>Declarative HTML templating at runtime without application recompiling and dynamic templates content generated by JSP and JSTL.</li>
							<li>Reducing GWT's role as a reliable bussiness logics framework by moving out a view decorations into HTML template.</li>
