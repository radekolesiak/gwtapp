<t:template tag="b" style="color:#336633;" styleclass="startapp-template">
	<div style="background-color: #e0e0e0;width:400px;">
		...
		<br />	
		<div class="tablediv" style="border:1px dotted #77dd77;margin:5px;padding:5px;">
		...
		<ul>
			...
			<li>UserRegister Bean - <a href="http://gwtapp.svn.sourceforge.net/viewvc/gwtapp/trunk/startapp/rpc/src/main/java/org/gwtapp/startapp/rpc/data/user/register/UserRegisterModelImpl.java?view=markup">UserRegisterModelImpl.java</a>			
				<ul>
					<li>Login MetaField - <small><a href="http://gwtapp.svn.sourceforge.net/viewvc/gwtapp/trunk/startapp/rpc/src/main/java/org/gwtapp/startapp/rpc/data/user/register/metafields/LoginMetaField.java?view=markup">LoginMetaField.java</a></small></li>
					<li>Password MetaField - <small><a href="http://gwtapp.svn.sourceforge.net/viewvc/gwtapp/trunk/startapp/rpc/src/main/java/org/gwtapp/startapp/rpc/data/user/register/metafields/PasswordMetaField.java?view=markup">PasswordMetaField.java</a></small></li>
					<li>Email MetaField - <small><a href="http://gwtapp.svn.sourceforge.net/viewvc/gwtapp/trunk/startapp/rpc/src/main/java/org/gwtapp/startapp/rpc/data/user/register/metafields/EmailMetaField.java?view=markup">EmailMetaField.java</a></small></li>
				</ul>			
			</li>
		</ul>
