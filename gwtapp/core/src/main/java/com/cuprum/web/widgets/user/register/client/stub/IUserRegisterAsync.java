...
public interface IUserRegisterAsync {
	void processUserRegister(TUserRegisterValue userRegister,
			AsyncCallback<TUserRegisterValue> callback);

	void confirm(String uid, AsyncCallback<Boolean> callback);
}
